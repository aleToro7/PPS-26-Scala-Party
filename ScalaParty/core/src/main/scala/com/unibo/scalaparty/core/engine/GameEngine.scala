...
trait GameEngine:
   ...
   *
   * @param world the current state of the game world, represented as a list of entities
   ...
   */
  def update(world: List[Entity], list: List[PlayerCommand], dt: Long): List[Entity]