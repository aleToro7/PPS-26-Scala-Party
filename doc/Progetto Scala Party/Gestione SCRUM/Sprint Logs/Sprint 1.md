...
| :----------------------------------- | :------------------------------------------------------------------------------------------------------------ | :--------------------------- | :-----------: | :--------: | :--------: | :-------: | :-----: | :------- |
| **Analisi architettura**             | Definizione della struttura generale del server                                                               | Diotallevi, Martini, Torelli |       1       |     1      |     1      |   **3**   | `To-Do` | Alta     |
...
| **TOTALE SPRINT POINTS**             |                                                                                                               |                              |    **13**     |   **11**   |   **11**   |  **35**   |         |          |
